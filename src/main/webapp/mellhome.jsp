				...
				<div class="button">
					<div class="button-container">
						<% boolean loggedIn2=false; if(cookies !=null){ for(Cookie cookie: cookies){
							...
							loggedIn2=true; } } } if(loggedIn2){ out.println("<a href='form.html'
							style='font-size: 20px;' class='btn'><span><i class='fa fa-plane'></i> Click here to find a
								ride!</span></a>");
							}
							else{
							out.println("<a href='register2.0.jsp' style='font-size: 20px;' class='btn'><span><i
										class='fa fa-plane'></i> Click here to find a ride!</span></a>");
							}%>
