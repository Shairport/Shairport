		            ...
		            <div class="col-md-6 col-lg-7 d-flex align-items-center">
		              <div class="card-body p-4 p-lg-5 text-black">
		                ...
		                <form action="register" method="POST">
		                  ...
		                  <h4 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Register for an account</h4>
		                  
		                  <h6 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Note: You must be a USC student to use this service</h6>
		
		                  <div class="form-outline mb-3">
		                    <input id="newName" name="newName" class="form-control form-control-lg" />
		                  ...
		                  <div class="form-outline mb-4">
		                    ...
		                    <label class="form-label" for="newEmail">USC Email address</label>
		                  </div>
		                  ...
		                  <div class="form-outline mb-4">
		                    <input type="password" id="newPasswordConfirmed" name="newPasswordConfirmed" class="form-control form-control-lg" />
		                    <label class="form-label" for="newPasswordConfirmed">Confirm Password</label>
		                  </div>
		
		                  <div class="pt-1 mb-4">
		                    <button class="btn btn-dark btn-lg btn-block" type="submit" style="background-color: #ff578c">Register</button>
		                  </div>
