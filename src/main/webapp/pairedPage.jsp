         ...
         <div class="receipt">
            ...
            <div class="details">
               <div class="item">
                  ...
                  <h3 style ="font-size: 1.3rem;">Max Albright, Toan Huynh</h3>
               </div>
               <div class="item">
                  <span>Ticket# </span>
                  <h3 style ="font-size: 1.3rem;">US6969</h3>
               </div>
               <div class="item">
                  <span>Departure Date</span>
                  <h3 style ="font-size: 1.3rem;">08/26/2018</h3>
               </div>
               <div class="item">
                  <span>Departure Time</span>
                  <h3 style ="font-size: 1.3rem;">4:03pm</h3>
               </div>
               <div class="item">
                  <span></span>
                  <h3></h3>
         ...
         <div class="receipt qr-code">
            <div class="details">
               ...
               <div class="item">
                  ...
                  <h3 style ="font-size: 1.3rem;">toanh@usc.edu</h3>
               </div>
               <div class="item">
                  <span>Paired User's Number</span>
                  <h3 style ="font-size: 1.3rem;">206-954-8882 </h3>
                  <hr>
